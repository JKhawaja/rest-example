...
//
// API "GitHub SSH Keys": CLI Commands
//
// Command:
// $ goagen
...
func RegisterCommands(app *cobra.Command, c *client.Client) {
	...
	command = &cobra.Command{
		Use:   "list",
		Short: `Given a list of GitHub usernames, responds with list of public SSH keys for each User (associated to their GitHub account).`,
	}
	tmp1 := new(ListKeysCommand)
	sub = &cobra.Command{
		Use:   `keys ["/keys"]`,
		Short: ``,
		Long: `
...
func (cmd *ListKeysCommand) Run(c *client.Client, args []string) error {
	...
	var payload client.ListKeysPayload
	if cmd.Payload != "" {
	...
	resp, err := c.ListKeys(ctx, path, payload)
	if err != nil {
